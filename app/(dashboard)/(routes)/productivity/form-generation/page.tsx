...
import { ArrowLeft, Book, ClipboardList, SpellCheck } from "lucide-react";
...
import SteppedProgress from "@/components/productivity/FormProgress";

const FormGenerationPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const resposne = await axios.post("/api/productivity/formGeneration", {
      ...
      setMessages((current) => [
        ...
        {
          role: "assistant",
          content: JSON.parse(resposne.data.content),
        },
      ]);
                  ...
                  <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="m-0 p-0">
                      <Input
                        ...
                        disabled={isLoading}
                        placeholder="A survey form for a customer feedback."
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
...
export default FormGenerationPage;
