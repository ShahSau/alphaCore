    ...
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto tracking-tight text-center mt-5">
          Unleash the power of ai to revolutionize industries, accelerate
          scientific discovery, and tackle society's greatest challenges.
        </p>
        {/* Tabs */}
        ...
        <div className="border border-white/30 p-2.5 rounded-xl mt-3">
          <motion.div
            className="aspect-video bg-cover border-white/30 rounded-lg"
            style={{
