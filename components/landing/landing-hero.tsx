  ...
  return (
    ...
    >
      ...
      <div className="container relative -mt-24 md:-mt-32">
        <h1 className="text-[60px] md:text-[148px] md:leading-none font-semibold tracking-tighter bg-white  bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center">
          AlphaCore
        </h1>
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          Unleash the power of ai to enhance everyday life in ways we have never
          imagined.
        </p>
